...
%         ax(3)=axes;hold on;grid on;
        ...
        ax(10) = axes;hold on;grid on;
        ax(11) = axes;hold on;grid on;
...
%         ylabel('Profile (µm)');
        ...
        axis square;
        set(ax(4),'units','normalized','pos',[-0.08 0.02 .4 .4]); %0.06 0.02 .4 .4
        ...
        %**************************************************************************
        % Axis 10 & 11- PB & OMV masks
        %**************************************************************************

        axes(ax(10));
        axis([-7000 7000 -7000 7000]);%was 3500
        axis square;
        set(ax(10),'units','normalized','pos',[0.15 0.02 .35 .35]); %small preview 0.36 0.01 .15 .15
        set(gca,'layer','top','xtick',-7000:800:7000,'ytick',-7000:800:7000,'xticklabel',[],'yticklabel',[]); %ws 3500:400:3500
        setappdata(gcf,'XlabDiv','100µm per div');
        ...
        axis([-7000 7000 -7000 7000]);%was 3500
        axis square;
        set(ax(11),'units','normalized','pos',[0.51 0.02 .35 .35]); %0.48 0.01 .15 .15 small preview
        set(gca,'layer','top','xtick',-7000:800:7000,'ytick',-7000:800:7000,'xticklabel',[],'yticklabel',[]); %ws 3500:400:3500
        setappdata(gcf,'XlabDiv','100µm per div');       
        ...
        axis([-7000 7000 -7000 7000]);%was 3500
        axis square;
        set(ax(5),'units','normalized','pos',[0.69 0.02 .4 .4]); %0.59
