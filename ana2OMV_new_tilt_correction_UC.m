...
%**************************************************************************     
    for iGroup=1:size(AngleGroups,1)
        ...
        zeropointZZ=(find(RR(idxGroupCo{iGroup}(iSortCo{iGroup}))<4882&RR(idxGroupCo{iGroup}(iSortCo{iGroup}))>4852)); % converted from prvious code (double and multiple by 4.4179e-6/4.581e-6 camera resolutiosn differences_
